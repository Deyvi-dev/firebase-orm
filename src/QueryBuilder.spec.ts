...
import { IQueryExecutor, IFirestoreQueryLine, FirestoreOperators } from './types';
...
class FakeExecutor implements IQueryExecutor<Test> {
  public queries: IFirestoreQueryLine[];
  execute(queries: IFirestoreQueryLine[]): Promise<Test[]> {
